...
**（2）Implemented features such as "Create Post", "Nearby Posts As Gallery" and "Nearby Posts In Map" with Ant Design**

**（3）Microsoft Word - Xing Wan Resume .doImplemented features such as "Create Post", "Nearby Posts As Gallery" and "Nearby Posts In Map" with Ant Design, GeoLocation API and Google Map API**
...
谢谢~
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3OTM1NzY2NCw1Mjc5NzM1OTYsLTk0Mz
IyOTE5MiwtMTcwMjA1NzYwMSwxNDg4NTgxMDUxLDE1NDIwMDE4
NzcsODk2NDY0MTg1LDEyMDkwNjYyMTksOTU5OTUwOTk4LC0xNz
Y3NjMwNDc3LC0xNjA3ODc0OTA1LDE4NzQ1ODgxOTEsLTEzMzE2
NjYwMSwzMjAyMzMwMTUsLTE0NzYyNDkxNzMsLTE4MjIzODM3Nz
gsNTA2ODExMzQ2XX0=
-->