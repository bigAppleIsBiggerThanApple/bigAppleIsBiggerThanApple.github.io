...
**（1）Create posts**
In this web application, you could simply upload your posts with a create post button. And The first tab will render all the user post images around you.
...
谢谢~
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkyMDA0NjU1LDE0ODg1ODEwNTEsMTU0Mj
